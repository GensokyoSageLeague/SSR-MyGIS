...
namespace MyGIS.Tools
{
    ...
    public class BufferTool : Tool
    {
        ...
        public override bool Execute(ICancelProgressHandler cancelProgressHandler)
        {
            ...
            if (DotSpatial.Analysis.Buffer.AddBuffer(inputFeatures, bufferDistance, outputFeatures, cancelProgressHandler))
            {
                outputFeatures.Save();
                return true;
            }
